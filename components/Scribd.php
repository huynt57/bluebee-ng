...
class Scribd {
    ...
    public function downloadPdfFromUrl($doc_id, $doc_type) {
        $method = "docs.getDownloadUrl";
        $params['doc_id'] = $doc_id;
        $params['doc_type'] = $doc_type;
        $data_array = $this->postRequest($method, $params);
        return $data_array['download_url'];
    }

    public function getPreviewImage($doc_id, $width, $height) {
        $method = "thumbnail.get";
        $params['doc_id'] = $doc_id;
        $params['width'] = $width;
        $params['height'] = $height;
        $data_array = $this->postRequest($method, $params);
        return $data_array['thumbnail_url'];
    }
