                                            ...
                                            <div class="navbar navbar-default" role="navigation">
                                                ...
                                                <nav class="collapse collapsing navbar-collapse">
                                                    <ul class="nav navbar-nav navbar-center">
                                                        <li class="parent">
                                                            <a href="index-2.html">Home<span class="item-new">New</span></a>
                                                            <ul class="sub">
                                                                <li><a href="index-2.html">Creative</a></li>
                                                            ...
                                                            <ul class="sub">
                                                                <li class="sub-wrapper">
                                                                    ...
                                                                    <div class="promo-block text-right">
                                                                        <a href="#">
                                                                            <img src="content/img/megamenu-big.jpg" class="replace-2x" width="253" height="457" alt="">
                                                                        </a>
                                                                    </div><!-- .promo-block -->
                                                                </li>
                                                            </ul><!-- .sub -->
                            ...
                            <ul>
                                ...
                                <li data-delay="8000" data-transition="fade" data-slotamount="7" data-masterspeed="2000">
                                    <div class="elements">
                                        ...
                                        <a href="http://themeforest.net/item/progressive-multipurpose-responsive-template/7197521"
                                           class="tp-caption btn orang lfb skewtobottom"
                                           data-x="509"
                                           data-y="338"
                                           data-speed="1000"
                                           data-start="1500"
                                    ...
                                    <div class="carousel-box load overflow" data-carousel-pagination="true" data-carousel-nav="false" data-carousel-one="true" data-autoplay-disable="true">
                                        ...
                                        <div class="row">
                                            <div class="carousel no-responsive">
                                                <div class="post">
                                                    <h2 class="entry-title"><a href="http://template.progressive.itembridge.com/blog-view.html">Lorem ipsum dolor sit.</a></h2>
                    ...
                    <div class="row sidebar">
                        ...
                        <aside class="col-xs-12 col-sm-6 col-md-3 widget newsletter">
                            ...
                            <div>
                                ...
                                <div class="clearfix"></div>
                                <form class="subscribe-form" method="post" action="http://template.progressive.itembridge.com/3.0.1/php/subscribe.php">
